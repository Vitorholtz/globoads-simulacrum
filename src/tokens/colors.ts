  ...
  },
  {
    ...
    tokens: [
      ...
      },
      {
        ...
        description: 'Superfície transparente. Utilizada em elementos e componentes sem fundo definido, permitindo que o conteúdo subjacente apareça.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tokens: [
      // Solid
      {
        ...
        description: 'Fundo sólido no estado de hover para elementos com cor de destaque primária. Aplicado em botões primários e controles interativos ao receber o cursor.',
      },
      {
        type: 'solid',
        value: '#0045B6',
        ...
        description: 'Fundo sólido no estado de pressionamento (active) para elementos com cor de destaque primária. Indica a confirmação da ação pelo usuário.',
      },
      {
        type: 'solid',
        value: '#005DD91F',
        ...
        description: 'Fundo ghost no estado de hover para ações secundárias e controles de menor hierarquia. Mantém transparência parcial para não competir com a superfície subjacente.',
      },
      {
        type: 'solid',
        value: '#005DD933',
        ...
        description: 'Fundo ghost no estado de pressionamento para ações secundárias. Opacidade ligeiramente maior que o hover para reforçar o feedback visual de clique.',
      },
      // Gradient
      {
        type: 'gradient',
        ...
        description: 'Gradiente de destaque escurecido para o estado de hover. Mantém a identidade visual do gradiente principal com maior profundidade ao receber o cursor.',
      },
      {
        type: 'gradient',
        stops: ['#0045B6', '#5D00B3'],
        ...
        description: 'Gradiente de destaque em seu tom mais escuro para o estado de pressionamento. Fornece contraste adicional no momento da ação confirmada pelo usuário.',
      },
      // Critical
      {
        type: 'solid',
        ...
        description: 'Fundo sólido crítico no estado de hover. Aplicado em botões e ações destrutivas ao receber o cursor, reforçando o caráter de alerta.',
      },
      {
        type: 'solid',
        value: '#7A0237',
        ...
        description: 'Fundo sólido crítico no estado de pressionamento. Tom mais profundo que o hover crítico para confirmar visualmente a intenção do usuário em ações destrutivas.',
      },
      {
        type: 'solid',
        value: '#B706341F',
        ...
        description: 'Fundo ghost crítico no estado de hover. Sinaliza interatividade em controles sensíveis sem ocupar toda a área com cor de alerta.',
      },
      {
        type: 'solid',
        value: '#B7063433',
        ...
        description: 'Fundo ghost crítico no estado de pressionamento. Opacidade ligeiramente maior que o hover para reforçar o feedback de confirmação em ações destrutivas.',
      },
    ],
  },
  {
    ...
    tokens: [
      {
        ...
        description: 'Sobreposição preta muito sutil para hover de itens de lista e estados selecionados. Mantém a superfície quase intacta enquanto sinaliza interatividade.',
      },
      {
        type: 'solid',
        value: '#00000012',
        ...
        description: 'Sobreposição preta leve para hover de botões ícone em superfície clara. Aplicado em clearBtn de campos de texto e controles similares.',
      },
      {
        type: 'solid',
        value: '#0000001F',
        ...
        description: 'Sobreposição preta média para o estado de pressionamento de botões ícone em superfície clara. Opacidade maior que o hover para reforçar o feedback de clique.',
      },
      {
        type: 'solid',
        value: '#FFFFFF2E',
        ...
        description: 'Sobreposição branca leve para hover de botões ícone sobre superfícies escuras ou coloridas. Aplicado em closeBtn do Toast e controles em fundos de alta saturação.',
      },
      {
        type: 'solid',
        value: '#FFFFFF4D',
        ...
        description: 'Sobreposição branca média para o estado de pressionamento sobre superfícies escuras. Opacidade maior que o hover para indicar a confirmação da ação.',
      },
      {
        type: 'solid',
        value: '#FFFFFF8C',
        ...
        description: 'Sobreposição branca para o anel de foco de elementos em superfície escura. Garante visibilidade do indicador de acessibilidade sem depender da cor de foco padrão.',
      },
    ],
  },
]
