...
export const FOCUS_TOKENS: FocusToken[] = [
  {
    ...
    description: 'Duplo anel com gap branco. Usado em botões, chips, cards interativos, tabs, breadcrumb e outros elementos focáveis que não possuem borda própria.',
  },
  {
    ...
    description: 'Anel simples sem gap. Reforça a borda existente do componente. Usado em TextField, Textarea, Select, Combobox e DatePicker.',
  },
]
