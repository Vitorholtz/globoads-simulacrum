...
import { SELECT_SIZES, SELECT_GUIDELINES } from '../../tokens/select'
    ...
    <div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.stylesGrid}>
          <div className={styles.styleCard}>
            ...
            <div className={styles.styleBody}>
              ...
              <span className={`type-body-sm ${styles.styleDesc}`}>
                Estado inicial do campo quando nenhuma opção foi selecionada. O texto de
                placeholder orienta o usuário sobre o que selecionar.
              </span>
            </div>
          </div>
          ...
          <div className={styles.styleCard}>
            <div className={styles.stylePreview}>
              <Select options={OPTIONS} size="md" defaultValue="item-1" />
            </div>
            <div className={styles.styleBody}>
              <span className={`type-body-sm ${styles.styleName}`}>Filled</span>
              <span className={`type-body-sm ${styles.styleDesc}`}>
                Estado após a seleção de uma opção. O valor escolhido é exibido no campo
                com cor primária, diferenciando-se do placeholder.
              </span>
            </div>
          </div>
        </div>
          ...
          {SELECT_SIZES.map((size) => (
            <div key={size.id} className={styles.sizeRow}>
              <div className={styles.sizePreview}>
                <Select options={OPTIONS} size={size.id} />
              </div>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.configGrid}>
          ...
          <div className={styles.configCard}>
            ...
            <div className={styles.configBody}>
              ...
              <span className={`type-caption-sm ${styles.configDesc}`}>
                Campo de seleção básico com label e placeholder. Ponto de partida para a
          ...
          <div className={styles.configCard}>
            <div className={styles.configPreview}>
              <Select options={OPTIONS} optional />
            </div>
            <div className={styles.configBody}>
          ...
          <div className={styles.configCard}>
            <div className={styles.configPreview}>
              <Select options={OPTIONS} showLabel={false} />
            </div>
            <div className={styles.configBody}>
          ...
          <div className={styles.configCard}>
            ...
            <div className={styles.configBody}>
              ...
              <span className={`type-caption-sm ${styles.configDesc}`}>
                Texto de apoio abaixo do campo orienta o usuário sobre o contexto ou as
                opções disponíveis.
              </span>
            </div>
          </div>
          ...
          <div className={styles.configCard}>
            <div className={styles.configPreview}>
              <Select options={OPTIONS} defaultValue="item-1" />
            </div>
            <div className={styles.configBody}>
              <span className={`type-body-sm ${styles.configName}`}>Pré-selecionado</span>
              <span className={`type-caption-sm ${styles.configDesc}`}>
                Campo inicializado com um valor padrão já selecionado. Útil quando uma
                opção é a mais comum ou recomendada.
              </span>
            </div>
          </div>
