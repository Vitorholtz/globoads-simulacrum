...
import { TEXT_FIELD_SIZES, TEXT_FIELD_STATES, TEXT_FIELD_GUIDELINES } from '../../tokens/textField'
...
export default function TextFieldPage() {
  return (
    <div>
      ...
      {/* ── Escala de Tamanhos ── */}
      <section className={styles.section}>
        <SectionHeader icon="straighten" title="Escala de Tamanhos" count={`${TEXT_FIELD_SIZES.length} tamanhos`} />
      ...
      {/* ── Estados ── */}
      <section className={styles.section}>
        <SectionHeader icon="toggle_on" title="Estados" count={`${TEXT_FIELD_STATES.length} estados`} />
        ...
        <div className={styles.configGrid}>
          ...
          <div className={styles.configCard}>
            ...
            <div className={styles.configBody}>
              ...
              <span className={`type-caption-sm ${styles.configDesc}`}>Quando o contexto visual torna a label dispensável — ex: campo de busca isolado ou em um header.</span>
            </div>
          </div>
          ...
          <div className={styles.configCard}>
            ...
            <div className={styles.configBody}>
              ...
              <span className={`type-caption-sm ${styles.configDesc}`}>Ícone à esquerda reforça o tipo de dado esperado sem substituir a label.</span>
            </div>
          </div>
