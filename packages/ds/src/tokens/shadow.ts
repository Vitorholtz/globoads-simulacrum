...
export const SHADOW_TOKENS: ShadowToken[] = [
  ...
  },
  {
    ...
    description:
      'Elevação baixa. Usada em dropdowns, tooltips e elementos levemente destacados da superfície.',
  },
  {
    name: 'Shadow Base',
    ...
    description:
      'Elevação base. Padrão para cards interativos, modais e componentes de destaque intermediário.',
  },
  {
    name: 'Shadow High',
    ...
    description:
      'Elevação alta. Reservada para overlays, drawers e painéis que se sobrepõem ao conteúdo principal.',
  },
  {
    name: 'Shadow Diffuse',
    ...
    description:
      'Elevação máxima. Usada em diálogos e elementos que requerem a maior separação visual da camada base.',
  },
]
